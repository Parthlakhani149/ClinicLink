...
const styles = StyleSheet.create({
  ...
  resetButton: { backgroundColor: '#181a1b', borderRadius: 10, marginTop: 30, paddingVertical: 15, alignItems: 'center' },
  resetButtonText: { color: 'white', fontSize: 16, fontWeight: '600' },
  backToLogin: { color: 'gray', fontSize: 13, textAlign: 'center', marginTop: 20, textDecorationLine: 'underline' },
