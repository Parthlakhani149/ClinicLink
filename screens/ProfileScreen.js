...
const styles = StyleSheet.create({
  ...
  container: { flexGrow: 1, alignItems: 'center', paddingVertical: 40, backgroundColor: '#F8FAFC' },
  ...
  email: { fontSize: 14, color: '#6B7280', marginBottom: 30 },
  formContainer: { width: '90%' },
  label: { fontSize: 14, color: '#374151', marginTop: 15 },
  input: {
    backgroundColor: '#fff',
    borderWidth: 1,
    borderColor: '#D1D5DB',
